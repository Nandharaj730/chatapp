...
if (url.indexOf("rooms/") != -1) {
  _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create({
    ...
    received: function received(data) {
      document.querySelector("ul#message-container").insertAdjacentHTML("beforeend", "<li><b class='bg-light' >" + data.user.user_id + " : </b><p>" + data.context + "</p></li>");
    }
  });
}
...
/******/ });
//# sourceMappingURL=application-b58778f04a9a3a2d699c.js.map