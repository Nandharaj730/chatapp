...
if (url.indexOf("rooms/") != -1) {
  _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create({
    ...
    received: function received(data) {
      document.querySelector("ul#message-container").insertAdjacentHTML("beforeend", "<li><b>" + data.from + "<p> : " + data.context + "</p></b></li>");
    }
  });
}
...
/******/ });
//# sourceMappingURL=application-6df5ccc5d4d435686007.js.map