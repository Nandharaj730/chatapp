...
if (url.indexOf("rooms/") != -1) {
  _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create({
    ...
    received: function received(data) {
      document.querySelector("ul#message-container").insertAdjacentHTML("beforeend", '<li><b>' + data.user.email + ' : </b><p>' + data.context + '</p></li>');
    }
  });
}
...
/******/ });
//# sourceMappingURL=application-c1de9b0444455dcb651f.js.map