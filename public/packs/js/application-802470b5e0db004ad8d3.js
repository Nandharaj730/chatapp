...
if (url.indexOf("rooms/") != -1) {
  _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create({
    ...
    received: function received(data) {
      document.querySelector("ul#message-container").insertAdjacentHTML("beforeend", "<li><b>" + data.from + "</b><p> : " + data.context + "</p></li>");
    }
  });
}
...
/******/ });
//# sourceMappingURL=application-802470b5e0db004ad8d3.js.map