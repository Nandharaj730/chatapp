...
if (url.indexOf("rooms/") != -1) {
  _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create({
    ...
    received: function received(data) {
      document.querySelector("ul#message-container").insertAdjacentHTML("beforeend", '<li><b>' + data.user.id + ' : </b><p>' + data.context + '</p></li>');
    }
  });
}
...
/******/ });
//# sourceMappingURL=application-50a6a903117af63e9c4b.js.map