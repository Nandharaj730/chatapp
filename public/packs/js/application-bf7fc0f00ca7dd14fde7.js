...
if (url.indexOf("rooms/") != -1) {
  _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create({
    ...
    received: function received(data) {
      document.querySelector("ul#message-container").insertAdjacentHTML("beforeend", "<li><p>" + data.from + " : " + data.context + "</p></li>");
    }
  });
}
...
/******/ });
//# sourceMappingURL=application-bf7fc0f00ca7dd14fde7.js.map