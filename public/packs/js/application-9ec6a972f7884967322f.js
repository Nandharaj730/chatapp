...
if (url.indexOf("rooms/") != -1) {
  _consumer__WEBPACK_IMPORTED_MODULE_0__["default"].subscriptions.create({
    ...
    received: function received(data) {
      document.querySelector("ul#message-container").insertAdjacentHTML("beforeend", '<li><b>' + data.user_id + ' : </b><p>' + data.context + '</p></li>');
    }
  });
}
...
/******/ });
//# sourceMappingURL=application-9ec6a972f7884967322f.js.map